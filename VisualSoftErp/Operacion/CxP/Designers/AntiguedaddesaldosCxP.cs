...
{
    public partial class AntiguedaddesaldosCxP : DevExpress.XtraReports.UI.XtraReport
    {
        int dbr = 0;
        int dbg = 0;
        int dbb = 0;
        ...
        private void tableCell21_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            tableCell21.BackColor = Color.FromArgb(dbr, dbg, dbb);
            tableCell21.ForeColor = Color.FromArgb(dfr, dfg, dfb);
        }
