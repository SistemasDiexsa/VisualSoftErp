...
{
    public partial class EntradasySalidasPorAutorizarRep : DevExpress.XtraReports.UI.XtraReport
    {
        public EntradasySalidasPorAutorizarRep()
        {
            InitializeComponent();
        }
        ...
        {
            string fecha = DateTime.Now.ToString("dddd dd 'de' MMMM 'del' yyyy");
            xrLabel3.Text = fecha;
        }
