...
{
    public partial class InventariofisicoDesigner : DevExpress.XtraReports.UI.XtraReport
    {
        int dbr = 0;
        int dbg = 0;
        int dbb = 0;
        ...
        public InventariofisicoDesigner()
        {
            InitializeComponent();
            stipoLogo = "C";
        ...
        private void tableCell5_AfterPrint(object sender, EventArgs e)
        {
        ...
        private void xrTableCellconteo_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            xrTableCellconteo.BackColor = Color.FromArgb(dbr, dbg, dbb);
            xrTableCellconteo.ForeColor = Color.FromArgb(dfr, dfg, dfb);
        }
        ...
        private void xrTableCellconteo_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            xrTableCellconteo.BackColor = Color.FromArgb(dbr, dbg, dbb);
            xrTableCellconteo.ForeColor = Color.FromArgb(dfr, dfg, dfb);
        }
