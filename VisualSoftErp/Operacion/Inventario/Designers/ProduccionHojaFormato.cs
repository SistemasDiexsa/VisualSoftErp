...
{
    public partial class ProduccionHojaFormato : DevExpress.XtraReports.UI.XtraReport
    {
        int dbr = 0;
        int dbg = 0;
        int dbb = 0;
        ...
        private void tableCell5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrTableCell8.BackColor = Color.FromArgb(dbr, dbg, dbb);
            xrTableCell8.ForeColor = Color.FromArgb(dfr, dfg, dfb);
