...
{
    public partial class RelaciondecomprasporarticuloDesigner : DevExpress.XtraReports.UI.XtraReport
    {
        int dbr = 0;
        int dbg = 0;
        int dbb = 0;
        ...
        public RelaciondecomprasporarticuloDesigner()
        {
            InitializeComponent();
            stipoLogo = "C";
        ...
        private void xrTableCell2_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            xrTableCell2.BackColor = Color.FromArgb(dbr, dbg, dbb);
            xrTableCell2.ForeColor = Color.FromArgb(dfr, dfg, dfb);
        }
