...
{
    public partial class RelaciondecomprasporproveedorResumenDesigner : DevExpress.XtraReports.UI.XtraReport
    {
        public RelaciondecomprasporproveedorResumenDesigner()
        {
            InitializeComponent();
        }
