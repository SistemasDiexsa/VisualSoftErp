...
{
    public partial class EstadisticaPorProveedorResumenDesigner : DevExpress.XtraReports.UI.XtraReport
    {
        public int IMPCANT { get; set; }
        public EstadisticaPorProveedorResumenDesigner()
        {
            InitializeComponent();
        }
        ...
        private void CambiarFormatoEnCeldas(IEnumerable<XRControl> controles)
        {
            foreach (XRControl control in controles)
            {
                ...
                {
                    if (control.Name != "xrLabel16" && control.Name != "xrLabel36" && control.Name != "xrLabel38" && control.Name != "xrLabel34" && control.Name != "tableCell14" && control.Name != "xrTableCell6")
        ...
        private void EstadisticaPorProveedorResumenDesigner_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
