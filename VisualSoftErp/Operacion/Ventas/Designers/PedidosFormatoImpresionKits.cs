...
{
    public partial class PedidosFormatoImpresionKits : DevExpress.XtraReports.UI.XtraReport
    {
        int dbr = 0;
        int dbg = 0;
        int dbb = 0;
        ...
        public PedidosFormatoImpresionKits()
        {
            InitializeComponent();
        }
        ...
        private void xrLabelEmpPH_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (stipoLogo == "L")
            {
