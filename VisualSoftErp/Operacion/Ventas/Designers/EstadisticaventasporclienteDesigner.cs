...
{
    public partial class EstadisticaventasporclienteDesigner : DevExpress.XtraReports.UI.XtraReport
    {
        int dbr = 0;
        int dbg = 0;
        int dbb = 0;
        ...
        public EstadisticaventasporclienteDesigner()
        {
            InitializeComponent();
            stipoLogo = "C";
        ...
        private void EstadisticaventasporclienteDesigner_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            Detail.SortFields.Add(new GroupField("ClientesID", XRColumnSortOrder.Ascending));
